...
#define MP3_RX 25//RX of Serial MP3 module connect to D7 of Arduino
#define MP3_TX 26//TX to D8, note that D8 can not be used as RX on Mega2560, you should modify this if you donot use Arduino UNO

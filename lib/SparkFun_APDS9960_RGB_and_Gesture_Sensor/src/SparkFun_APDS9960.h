...
#define GESTURE_SENSITIVITY_1   25
...
#define APDS9960_ID_1           0xAB  // Original SparkFun APDS-9960
#define APDS9960_ID_2           0xA8  // Revision B
#define APDS9960_ID_3           0x9C  // Chinese clone variant
#define APDS9960_ID_4           0x39  // Another clone variant
...
#define DEFAULT_CONFIG1         0x00    // No 12x wait (WTIME) factor (예약비트 0으로 클리어)
...
#define DEFAULT_GPULSE          0x83    // 16us, 4 pulses (포화 방지)

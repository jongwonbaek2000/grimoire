...
bool SparkFun_APDS9960::init()
{
    ...
    if( !(id == APDS9960_ID_1 || id == APDS9960_ID_2 || id == APDS9960_ID_3 || id == APDS9960_ID_4) ) {
        return false;
    }
...
bool SparkFun_APDS9960::decodeGesture()
{
    ...
    if( (gesture_ud_count_ == -1) && (gesture_lr_count_ == 0) ) {
        ...
        gesture_motion_ = DIR_UP_RIGHT;
    } else if( (gesture_ud_count_ == 1) && (gesture_lr_count_ == -1) ) {
        gesture_motion_ = DIR_DOWN_LEFT;
    } else if( (gesture_ud_count_ == -1) && (gesture_lr_count_ == -1) ) {
        gesture_motion_ = DIR_UP_LEFT;
    } else if( (gesture_ud_count_ == 1) && (gesture_lr_count_ == 1) ) {
        gesture_motion_ = DIR_DOWN_RIGHT;
    } else {
        return false;
    }
    //Original: Just 4 motions
    /* Determine swipe direction */
    /*
    if( (gesture_ud_count_ == -1) && (gesture_lr_count_ == 0) ) {
        gesture_motion_ = DIR_UP;
